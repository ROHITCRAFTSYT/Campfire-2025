...
label child_incident:
    ...
    narrator "You see a young boy chasing a ball into a busy street. A truck is speeding toward him."
    
    show child at center
    with dissolve
    if renpy.loadable("audio/child/voice1.ogg"):
        voice "audio/child/voice1.ogg"
    ...
    if _return == "save_child":
        ...
        show guardian at center
        with dissolve
        if renpy.loadable("audio/guardian/voice3.ogg"):
            voice "audio/guardian/voice3.ogg"
        ...
        show child at center
        with dissolve
        if renpy.loadable("audio/child/voice2.ogg"):
            voice "audio/child/voice2.ogg"
        ...
        show guardian at center
        with dissolve
        if renpy.loadable("audio/guardian/voice4.ogg"):
            voice "audio/guardian/voice4.ogg"
...
label mother_incident:
    ...
    with dissolve
    if renpy.loadable("audio/mother/voice1.ogg"):
        voice "audio/mother/voice1.ogg"
    ...
    if _return == "save_mother":
        ...
        show guardian at center
        with dissolve
        if renpy.loadable("audio/guardian/voice5.ogg"):
            voice "audio/guardian/voice5.ogg"
        ...
        show mother at center
        with dissolve
        if renpy.loadable("audio/mother/voice2.ogg"):
            voice "audio/mother/voice2.ogg"
        ...
        show guardian at center
        with dissolve
        if renpy.loadable("audio/guardian/voice6.ogg"):
            voice "audio/guardian/voice6.ogg"
...
label scientist_incident:
    ...
    with dissolve
    if renpy.loadable("audio/scientist/voice1.ogg"):
        voice "audio/scientist/voice1.ogg"
    ...
    if _return == "save_scientist":
        ...
        show guardian at center
        with dissolve
        if renpy.loadable("audio/guardian/voice7.ogg"):
            voice "audio/guardian/voice7.ogg"
        ...
        show scientist at center
        with dissolve
        if renpy.loadable("audio/scientist/voice2.ogg"):
            voice "audio/scientist/voice2.ogg"
        ...
        show guardian at center
        with dissolve
        if renpy.loadable("audio/guardian/voice8.ogg"):
            voice "audio/guardian/voice8.ogg"
...
label construction_incident:
    ...
    with dissolve
    if renpy.loadable("audio/worker/voice1.ogg"):
        voice "audio/worker/voice1.ogg"
    ...
    if _return == "prevent_accident":
        ...
        show guardian at center
        with dissolve
        if renpy.loadable("audio/guardian/voice9.ogg"):
            voice "audio/guardian/voice9.ogg"
        ...
        show worker at center
        with dissolve
        if renpy.loadable("audio/worker/voice2.ogg"):
            voice "audio/worker/voice2.ogg"
        ...
        show guardian at center
        with dissolve
        if renpy.loadable("audio/guardian/voice10.ogg"):
            voice "audio/guardian/voice10.ogg"
...
label final_choice:
    ...
    show guardian at center
    with dissolve
    if renpy.loadable("audio/guardian/voice11.ogg"):
        voice "audio/guardian/voice11.ogg"
...
label ending_purist:
    ...
    show guardian at center
    with dissolve
    if renpy.loadable("audio/guardian/voice12.ogg"):
        voice "audio/guardian/voice12.ogg"
...
label ending_chaos:
    ...
    show guardian at center
    with dissolve
    if renpy.loadable("audio/guardian/voice13.ogg"):
        voice "audio/guardian/voice13.ogg"
...
label ending_catastrophe:
    ...
    show guardian at center
    with dissolve
    if renpy.loadable("audio/guardian/voice14.ogg"):
        voice "audio/guardian/voice14.ogg"
...
label ending_chaos_accepted:
    ...
    show guardian at center
    with dissolve
    if renpy.loadable("audio/guardian/voice15.ogg"):
        voice "audio/guardian/voice15.ogg"
...
label ending_reset:
    ...
    show guardian at center
    with dissolve
    if renpy.loadable("audio/guardian/voice16.ogg"):
        voice "audio/guardian/voice16.ogg"
...
label ending_sacrifice:
    ...
    show guardian at center
    with dissolve
    if renpy.loadable("audio/guardian/voice17.ogg"):
        voice "audio/guardian/voice17.ogg"
